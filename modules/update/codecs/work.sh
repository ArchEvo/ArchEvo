...
#video codecs
pacman -S --noconfirm --needed ffmpeg gstreamer gst-plugins-good gst-libav libavif libheif aom dav1d rav1e libde265 libdv libmpeg2 libtheora schroedinger libvpx x264 x265 xvidcore
...
if [ "$INPUT_GPU_DRIVER" == "nvidia" ] || [ "$INPUT_GPU_DRIVER" == "nvidia-lts" ]; then
    pacman -S --noconfirm --needed nvidia-utils
fi
